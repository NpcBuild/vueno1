 ...
 *
 *   https://github.com/shady-xia/vue-uploader-solutions/tree/master/vue-simple-uploader
 */
import {ACCEPT_CONFIG} from '@/setting'
  ...
  methods: {
    ...
    computeMD5(file) {
      ...
      function loadNext() {
        ...
        // if (start <= end) fileReader.readAsArrayBuffer(file.file.slice(start, end))
